...
## Deploy 
 ...
 3. Go to this forked repo and set secrets with name `KV_NAME` and fill with KV settings IDlsgidnj
    
 5. Edit this `README.md` file, then find and replace this button url bellow with yours `https://github.com/USER/REPO_NAME` then save it.
